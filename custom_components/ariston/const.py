...
PARAM_HP_CH_PRODUCED_TODAY = 'hp_ch_produced_today'
PARAM_HP_DHW_PRODUCED_TODAY = 'hp_dhw_produced_today'
PARAM_HP_CH_CONSUMED_TODAY = 'hp_ch_consumed_today'
PARAM_HP_DHW_CONSUMED_TODAY = 'hp_dhw_consumed_today'
PARAM_HP_CH_PRODUCED_LIFETIME = 'hp_ch_produced_lifetime'
PARAM_HP_DHW_PRODUCED_LIFETIME = 'hp_dhw_produced_lifetime'
PARAM_HP_CH_CONSUMED_LIFETIME = 'hp_ch_consumed_lifetime'
PARAM_HP_DHW_CONSUMED_LIFETIME = 'hp_dhw_consumed_lifetime'
PARAM_HP_CH_COP = 'hp_ch_cop'
PARAM_HP_DHW_COP = 'hp_dhw_cop'
PARAM_HP_TOTAL_PRODUCED_TODAY = 'hp_total_produced_today'
PARAM_HP_TOTAL_CONSUMED_TODAY = 'hp_total_consumed_today'
PARAM_HP_TOTAL_COP = 'hp_total_cop'
PARAM_HP_SCOP_RUNNING = 'hp_scop_running'
PARAM_HP_SCOP_365D = 'hp_scop_365d'
...
CONF_HP_SLOT_MODE = "hp_slot_mode"
HP_SLOT_MODE_VERBATIM = "verbatim"
HP_SLOT_MODE_SPLIT = "split"
